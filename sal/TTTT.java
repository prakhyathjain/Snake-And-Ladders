...
Listener o = new Listener(this); //whenever we are rolling the dice

 TTTT()
 {
	 JLabel bg=new JLabel(new ImageIcon("F:\\eclipse-workspace\\snakeAndLadders\\src\\sal\\bg.jpg"));
	 bg.setBounds(0,0,0,735);


	 JWindow window = new JWindow();

	 	window.getContentPane().add(  new JLabel("", new ImageIcon("F:\\eclipse-workspace\\snakeAndLadders\\src\\sal\\splash01.jpg"), SwingConstants.LEFT));
        ...
        window.dispose();
       	l=new JLabel[101];    								 //Labels for snake and ladder board
		m=new JLabel[6];									//Label for players (pawns) & starting point





//******************** Starting point with pawn label on it*****************

         m[1]=new JLabel();
	     m[1].setBounds(140,650,20,52);
	     m[1].setIcon(new ImageIcon("F:\\eclipse-workspace\\snakeAndLadders\\src\\sal\\player2.png"));
	     f.add(m[1]);

		 m[2]=new JLabel();
	     m[2].setBounds(70,650,20,52);
		 m[2].setIcon(new ImageIcon("F:\\eclipse-workspace\\snakeAndLadders\\src\\sal\\player1.png"));
		 f.add(m[2]);


		 m[4]=new JLabel();
	     m[4].setBounds(5,290,20,52);
	     m[4].setIcon(new ImageIcon("F:\\eclipse-workspace\\snakeAndLadders\\src\\sal\\player2.png"));
	     f.add(m[4]);

		 m[5]=new JLabel();
	     m[5].setBounds(5,340,20,52);
		 m[5].setIcon(new ImageIcon("F:\\eclipse-workspace\\snakeAndLadders\\src\\sal\\player1.png"));
		 f.add(m[5]);

		m[3]=new JLabel();
		m[3].setBounds(50,570,150,150);
		m[3].setIcon(new ImageIcon("F:\\eclipse-workspace\\snakeAndLadders\\src\\sal\\start.jpg"));
		f.add(m[3]);
...
//	Labels for Board boxes 100-90, 80-70, 60-50, 40-30, 20-10 are as follows ***************************************
		...
		int j=0;
			for(int i=100;i>90;i--)
			{
			    ...
			    l[i].setIcon(new ImageIcon("F:\\eclipse-workspace\\snakeAndLadders\\src\\sal//cut/"+i+".jpg"));
          	    f.add(l[i]);
          		j++;
			}
...
// Labels for REMAINING Board boxes are as follows  ********************************************************
		...
		tf.setIcon(new ImageIcon("F:\\eclipse-workspace\\snakeAndLadders\\src\\sal//aaaa.png"));
		f.add(tf);


		z=new JLabel();
		z.setBounds(0,0,200,100);
		z.setIcon(new ImageIcon("F:\\eclipse-workspace\\snakeAndLadders\\src\\sal//rms1.jpg"));
		f.add(z);
		...
		a3.setText("");
		a3.setIcon(new ImageIcon("F:\\eclipse-workspace\\snakeAndLadders\\src\\sal//dice.gif"));
...
//JTextField tf3.
    start=new JButton();
    start.setIcon(new ImageIcon("F:\\eclipse-workspace\\snakeAndLadders\\src\\sal//start.gif"));
    start.setBounds(50,580,150,60);
    start.addActionListener(o);
    f.add(start);

     au=new JButton();
     au.setIcon(new ImageIcon("F:\\eclipse-workspace\\snakeAndLadders\\src\\sal//about.gif"));
	 ...
	 f.add(au);
      ...
      reset.setIcon(new ImageIcon("F:\\eclipse-workspace\\snakeAndLadders\\src\\sal//reset.png"));
      f.add(reset);
	  ...
	  public void actionPerformed(ActionEvent e)
	  {
		  ...
		  else if(e.getSource()==d.au)
		  {
			  ...
			  JLabel 	a4=new JLabel();
			  		...
			  		a4.setText("");
			  		a4.setIcon(new ImageIcon("F:\\eclipse-workspace\\snakeAndLadders\\src\\sal//ma1.jpg"));
		jn.add(a4);
		  }
...
//*********************************   this if loop is for player 1(pawn) w is the number and this loop only work when w is even so even number is for player1
...
if(w%2==0)
  {d.screen.setText("Player 2 chance");
	  ...
	  w++;
          ...
          if((pc1+rno)<101)                                 // checking whether the value of player1 not exceed more than 100 while playing
          {
          ...
          //***************** checking whether a snake is their at our position or not *********************
